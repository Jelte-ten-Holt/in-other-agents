...
use InOtherAgents\Http\Controllers\AuthorizationServerMetadataController;
use InOtherAgents\Http\Controllers\DynamicClientRegistrationController;
use InOtherAgents\Http\Controllers\ProtectedResourceMetadataController;
...
if ((bool) config('agents.auth.oauth.dcr.enabled', true)) {
    $rateLimit = (string) config('agents.auth.oauth.dcr.rate_limit', '5,1');
